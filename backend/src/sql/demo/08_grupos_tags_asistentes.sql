...
VALUES ('gr-itsa-junta', 2, 'Junta Directiva', 'Órgano de gobierno de la asociación');

INSERT INTO groups (id, tenant_id, name, description)
VALUES ('gr-itsa-fiestas', 2, 'Comisión de Fiestas', 'Organización de eventos y fiestas populares');

INSERT INTO groups (id, tenant_id, name, description)
VALUES ('gr-itsa-cultura', 2, 'Comisión de Cultura', 'Programación cultural: charlas, cursos, talleres');
...
INSERT INTO groups (id, tenant_id, name, description)
VALUES ('gr-mendi-junta', 3, 'Junta Vecinal', 'Junta directiva de la asociación vecinal');

INSERT INTO groups (id, tenant_id, name, description)
VALUES ('gr-mendi-fiestas', 3, 'Comisión de Fiestas', 'Organización fiestas patronales y eventos del barrio');
...
INSERT INTO tags (id, tenant_id, name, color) VALUES ('tag-itsa-gastro', 2, 'Gastronomía', '#ef4444');
INSERT INTO tags (id, tenant_id, name, color) VALUES ('tag-itsa-cultura', 2, 'Cultura', '#8b5cf6');
INSERT INTO tags (id, tenant_id, name, color) VALUES ('tag-itsa-natura', 2, 'Naturaleza', '#22c55e');
INSERT INTO tags (id, tenant_id, name, color) VALUES ('tag-itsa-musica', 2, 'Música', '#f59e0b');
...
INSERT INTO tags (id, tenant_id, name, color) VALUES ('tag-mendi-social', 3, 'Social', '#06b6d4');
INSERT INTO tags (id, tenant_id, name, color) VALUES ('tag-mendi-senior', 3, 'Mayores', '#f97316');
INSERT INTO tags (id, tenant_id, name, color) VALUES ('tag-mendi-eco', 3, 'Ecología', '#22c55e');
