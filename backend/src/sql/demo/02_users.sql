...
INSERT INTO memberships (tenant_id, user_id, role) VALUES (2, 'demo-itsa-admin', 'ADMIN');
...
INSERT INTO memberships (tenant_id, user_id, role) VALUES (2, 'demo-itsa-jokin', 'MEMBER');
...
INSERT INTO memberships (tenant_id, user_id, role) VALUES (2, 'demo-itsa-amaia', 'MEMBER');
...
INSERT INTO memberships (tenant_id, user_id, role) VALUES (2, 'demo-itsa-ander', 'MEMBER');
...
INSERT INTO memberships (tenant_id, user_id, role) VALUES (3, 'demo-mendi-admin', 'ADMIN');

-- Member: Laura García
INSERT INTO users (id, email, password_hash, name)
VALUES ('demo-mendi-laura', 'laura@mendizabal.org', '$2a$10$LK3xG6y6q5mQzH9p2Bk7Z.VJ3YfGd8vKjXhE1wR9tN4aU2cS6mO0e', 'Laura García');

INSERT INTO memberships (tenant_id, user_id, role) VALUES (3, 'demo-mendi-laura', 'MEMBER');

-- Member: Pablo Ruiz
INSERT INTO users (id, email, password_hash, name)
VALUES ('demo-mendi-pablo', 'pablo@mendizabal.org', '$2a$10$LK3xG6y6q5mQzH9p2Bk7Z.VJ3YfGd8vKjXhE1wR9tN4aU2cS6mO0e', 'Pablo Ruiz');

INSERT INTO memberships (tenant_id, user_id, role) VALUES (3, 'demo-mendi-pablo', 'MEMBER');
